 ...
 * <p>
 * 再次看tomcat源码，我多了一些思考：就是一个东西最好的是设计还是代码结构。。。？如果一个代码设计很好，也就是通常说的架构很好
 * 当然这个架构要比这个设计模式高的多的多了。我认为是架构高于设计模式。战略高于战术.
 *
 * @author liuxu
 */
public final class Bootstrap {
    ...
    static {
        ...
        if (homeFile == null) {
             ...
             * 但是，如果是在底层，你处理这个异常了，那么就是说相当于你是吞掉了这个异常信息，那么上层的环境 是不能够获取这个异常信息的
             * 这个异常处理涉及到问题：如果真的出现这个异常，是不是说系统就跑不起来了，还是说，如果出现异常，我们
             * 还是可以有补救方案的，比如说，我们的很多框架都会默认的加载一些配置文件，但是如果这个配置文件不存在
             * 我们一定要退出系统了吗，或者是跑出去这个异常信息，这个是错误的做法，我们应该还要留一个后手，就是，
    ...
    public static String getCatalinaHome() {
        return catalinaHomeFile.getPath().replaceAll("\\\\","/");
    }
    ...
    public static String getCatalinaBase() {
        return catalinaBaseFile.getPath().replaceAll("\\\\","/");
    }
